...
StateMenu::StateMenu() {
    ...
    if(!music.openFromFile("Music/Space-Unicorn-Parry-Gripp-and-Brianne-Drouhard.ogg"))
    {
    ...
    if(!BackgroundTexture.loadFromFile("BackGrounds/GameMenu.png"))
    {
    ...
    else
    {
        ...
        WindowSize.x = gameConfig::screenWidth;             //Get size of window_ptr.
        WindowSize.y = gameConfig::screenHeight;
